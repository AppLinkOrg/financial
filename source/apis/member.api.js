...
export class MemberApi{
    ...
    addinfo(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/addinfo',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    pandaun(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/pandaun',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    register2(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/register2',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    userinfo2(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/userinfo2',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
